            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>maintenance/viewEquipment" method="POST" id="searchList">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="#" data-userid="" title="View History"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
