            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>Venue/venue_insert" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="room_no">Room No:</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('room_no'); ?>" id="room_no" name="room_no" maxlength="128" placeholder="Room Number">
                                    </div>
