                    ...
                    <tr>
                        ...
                        <td><?php echo $record->remark ?></td>
                         <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>main/disapproveJobDescriptionDisapprove?id=<?php echo $record->jobId ?>" data-userid="" title="Disapprove"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
